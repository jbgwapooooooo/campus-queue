...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun register() {
        ...
        val request = RegisterRequest(email, password, data)
...
import com.example.campusqueue.network.RetrofitClient
import com.example.campusqueue.network.models.*
import com.example.campusqueue.utils.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response
        ...
        RetrofitClient.instance.getDashboard().enqueue(object : Callback<SupabaseUserResponse> {
            override fun onResponse(call: Call<SupabaseUserResponse>, response: Response<SupabaseUserResponse>) {
                ...
                if (response.isSuccessful) {
                    ...
                    val msg = res?.user_metadata?.get("name") ?: res?.email
                    tvMessage.text = "Dashboard:\\nWelcome back! $msg"
                } else {
...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnEditProfile.setOnClickListener { startActivity(Intent(this, UpdateProfileActivity::class.java)) }
        btnChangePassword.setOnClickListener { startActivity(Intent(this, ChangePasswordActivity::class.java)) }
    }
...
class UpdateProfileActivity : AppCompatActivity() {
    ...
    private fun updateProfile() {
        ...
        setLoading(true)
        val data = mapOf("name" to name)
        val request = UpdateProfileRequest(data)
        RetrofitClient.instance.updateProfile(request).enqueue(object : Callback<SupabaseUserResponse> {
            override fun onResponse(call: Call<SupabaseUserResponse>, response: Response<SupabaseUserResponse>) {
                setLoading(false)
                if (response.isSuccessful) {
...
class ChangePasswordActivity : AppCompatActivity() {
    ...
    private fun changePassword() {
        ...
        RetrofitClient.instance.changePassword(request).enqueue(object : Callback<SupabaseUserResponse> {
            override fun onResponse(call: Call<SupabaseUserResponse>, response: Response<SupabaseUserResponse>) {
                setLoading(false)
                if (response.isSuccessful) {
...
print("UI Supabase Refactor completed.")
